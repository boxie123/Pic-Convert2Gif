...
set "subfolder=converted_png2gif"
...
echo "Convert complete, saved in the ./converted_png2gif folder. Press Enter to exit the program."
echo "转换完成，已保存在 ./converted_png2gif 文件夹中, 按回车退出程序"
pause
